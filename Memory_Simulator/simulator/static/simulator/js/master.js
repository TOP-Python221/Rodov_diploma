	...
	function updateCount(value){
		console.log(value);
	    document.getElementById('clicks-field').innerHTML = value;
	    document.getElementById('clicks-field').value = value;
	    if($(".matched").length == $(".card").length){
			value = 0;
			reset.onclick = document.getElementById('clicks-field').innerHTML = 0;
		};
	};
...
var h1 = document.getElementsById('time')[0];
